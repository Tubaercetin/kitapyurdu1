...
public class ProductPage {
    ...
    public void selectProduct() {
        ...
        methods.sendKey(By.xpath("//input[@name='quantity']"), "3"); //miktarı 3 yapar
        methods.waitBySeconds(3);
        ...
        methods.waitBySeconds(2);
        methods.sendKeys(By.id("address-lastname-title"),"Erçetin");
        methods.waitBySeconds(3);
        methods.selectByText(By.cssSelector("select[id='address-zone-id']"), "İstanbul");
        methods.waitBySeconds(3);
        methods.selectByText(By.cssSelector("select#address-county-id"),"KAĞITHANE");
        methods.waitBySeconds(3);
        methods.sendKey(By.cssSelector("input[id='district']"),"Kağıthane");
        methods.waitBySeconds(3);
